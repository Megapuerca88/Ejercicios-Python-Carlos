...
#Un ciclo anidado es un ciclo dentro del bloque de otro ciclo. 
# Por cada iteración del ciclo externo, el ciclo interno 
# se ejecuta completamente. 
# Total de ejecuciones = iteraciones_externo × iteraciones_interno.
#Cuándo usarlos: tablas, matrices, patrones, 
# comparación de dos listas. Si necesitas más de 2 niveles de anidación, 
...
# Necesitarás un if dentro del for interno que verifique 
# si el resultado es impar usando el operador %.

#El dos sirve para que solo se pueda mostrar impar
...
#Separado para que no quede feo
...
#break: termina el ciclo inmediatamente, aunque la condición todavía sea True.
#  El programa continúa después del ciclo.
#continue: salta el resto del bloque actual y pasa a la siguiente iteración.
# El ciclo NO termina.
#Úsalos con criterio. Abusar de ellos hace el código difícil de seguir. 
# Son válidos cuando simplifican la lógica, no cuando la complican.
...
#Tu turno: Reescribe el bloque de "Solo aprobados" del Ejercicio
#  sin usar continue, usando un if normal. 
